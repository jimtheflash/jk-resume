...
%---------------------------------------------------------
  \cventry
    {Data Scientist, \textit{IT Data Science}} % Job title
    {ABC Supply Co.} % Organization
    {Chicago, IL, USA} % Location
    {2019 - present} % Date(s)
    {
      \begin{cvitems}
        \item {Lead data science initiatives across several domains, including workforce management, associate retention, security, and e-comm}
        ...
        \item {Test hypotheses and tell stories with data to C-Suite audiences and other stakeholders}
...
%---------------------------------------------------------
 \cventry
    {Director, \textit{Insights \& Analytics}} % Job title
...
%THIS IS A SECOND POSITION AT SAME ORG, leave org/location blank
  \cventry
    {Data Scientist - Senior Data Scientist, \textit{Product Research \& Development}} % Job title
    {} % Organization
    {} % Location
    {2015 - 2016} % Date(s)
    {
